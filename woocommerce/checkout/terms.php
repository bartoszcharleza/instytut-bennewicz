...
?>
	<div class="woocommerce-terms-and-conditions-wrapper">
		<h3 class="heading--xs heading">Wyraź zgodę</h3>
		<?php
		/**
			...
			<p class="form-row validate-required">
				<label class="woocommerce-form__label woocommerce-form__label-for-checkbox checkbox">
					<input type="checkbox" class="woocommerce-form__input woocommerce-form__input-checkbox input-checkbox" name="terms" <?php checked(apply_filters('woocommerce_terms_is_checked_default', isset($_POST['terms'])), true); // WPCS: input var ok, csrf ok. 
																																		?> id="terms" />
					<span class="woocommerce-terms-and-conditions-checkbox-text"> Przeczytałem/am i akceptuję <a href="<?php echo esc_url(get_permalink(wc_terms_and_conditions_page_id())) ?>" target="_blank">regulamin</a><?php //wc_terms_and_conditions_checkbox_text(); 
