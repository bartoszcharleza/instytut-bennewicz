...
?>
<section class="section section-form-login">
    <div data-aos="fade-up" class="section-container">
        ...
        <?php if ('yes' === get_option('woocommerce_enable_myaccount_registration')) : ?>
            ...
            <div class="login-and-register" id="customer_login">

                <div class="login-container">
                    <img class="login-logo" src="/wp-content/themes/website_style/images/bennewicz_favicon.svg" loading="lazy">

                <?php endif; ?>

                <h1 class="login-title">Panel klienta<br><span class="heading--l">Logowanie</span></h1>
                ...
                <form class="woocommerce-form woocommerce-form-login login" method="post">
                    ...
                    <p class="form-row form-row-wide">
                        ...
                        <button type="submit" class="btn btn--secondary" name="login" value="<?php esc_attr_e('Log in', 'woocommerce'); ?>"><?php esc_html_e('Log in', 'woocommerce'); ?></button>
                        <label class="woocommerce-form__label woocommerce-form__label-for-checkbox woocommerce-form-login__rememberme">
                            <input class="woocommerce-form__input woocommerce-form__input-checkbox" name="rememberme" type="checkbox" id="rememberme" value="forever" /> <span><?php esc_html_e('Remember me', 'woocommerce'); ?></span>
                        </label>
                    </p>
                    <div class="woocommerce-LostPassword lost_password form-row-wide">
                        <p>Zapomniałem hasła. <a href="<?php echo esc_url(wp_lostpassword_url()); ?>">Przypomnij hasło</a></p>
                    </div>
                ...
                <div class="register-container">
                    ...
                    <h2 class="heading--l"><?php esc_html_e('Register', 'woocommerce'); ?></h2>
                    ...
                    <form method="post" class="woocommerce-form woocommerce-form-register register" <?php do_action('woocommerce_register_form_tag'); ?>>
                        ...
                        <p class="woocommerce-form-row form-row form-row-wide register-button-wrap">
